...
<header>
    <div class="header">
        ...
        <?php if (isset($_SESSION['user'])) : ?>
            <button id="second" class="btn-red-index delay" onclick="destroy_session()"><span class="fix-skew">Logout</span></button>
            <button id="first" class="btn-blue" onclick="redirectPA()"><span class="fix-skew">Personal Area</span></button>
        <?php else: ?>
